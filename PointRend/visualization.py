...
def main():
    ...
    for idx in range(len(test_dict)):#tqdm(paths):
        ...
        cfg.merge_from_file("/ssd/JH/detectron2_t/projects/PointRend/configs/InstanceSegmentation/pointrend_rcnn_R_50_FPN_1x_coco.yaml")
        cfg.MODEL.ROI_HEADS.SCORE_THRESH_TEST = 0.5
        cfg.MODEL.WEIGHTS = "/ssd/JH/detectron2_t/projects/PointRend/output/model_final.pth"
